...
export class QuoteComponent implements OnInit {
  ...
  quotes: Quote[] = [
    ...
    new Quote(2,'Machel Raini','Roses are red, violets are blue, vodka costs less than dinner for two.',new Date(2020,3,14)),
    new Quote(3,'Florence Nightingale','Women have no sympathy and my experience of women is almost as large as Europe',new Date(2020,3,14)),
